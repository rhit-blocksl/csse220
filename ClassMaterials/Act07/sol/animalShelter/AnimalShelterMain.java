...
//            if (found != null) {
//                System.out.println("Animal found: " + found);
//                System.out.print("Are you sure you want to remove this animal? (y/n) ");
//                String confirmation = scanner.nextLine().trim().toLowerCase();
//                if (confirmation.equals("y")) {
//                    this.animals.remove(id);
//                    // Remove the animal from this.animalsByName, but not any other animals with the same name
//                    for (String name : this.animalsByName.keySet()) {
//                        if (id == this.animalsByName.get(name).getID()) {
//                            this.animalsByName.remove(name);
//                        }
//                    }
//                }
//            } else {
...
//            System.out.println("  remove animal - Remove an animal from the shelter");
